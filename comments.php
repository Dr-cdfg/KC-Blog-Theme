...
<div style="margin : 0px 7px 0px 7px;" id="comments">
    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
    	...
    	<h3 style="margin : 0px 7px 0px 7px;" id="response"><?php _e('添加新评论'); ?></h3>
    	<form style="margin : 0px 7px 0px 7px;" method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
    		...
    		<p>
    			...
    			<input type="url" name="url" id="url" class="text mdui-textfield-input" placeholder="<?php _e('http://'); ?>" value="<?php $this->remember('url'); ?>"<?php if ($this->options->commentsRequireURL): ?> required<?php endif; ?> />
    		</p>
            <?php endif; ?>
    		<p>
